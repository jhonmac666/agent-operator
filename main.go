...
import (
	...
	"github.com/jhonmac666/agent-operator/controllers"

	logf "sigs.k8s.io/controller-runtime/pkg/log"

	k8sruntime "k8s.io/apimachinery/pkg/runtime"

	agentoperatorv1 "github.com/jhonmac666/agent-operator/api/v1"
	agentoperatorv1beta1 "github.com/jhonmac666/agent-operator/api/v1beta1"
	"github.com/jhonmac666/agent-operator/version"
...
func main() {
	...
	logf.SetLogger(zap.New(zap.UseFlagOptions(&opts)).WithName("vc"))
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "819a9291.vc.io",
	...
	if enableWebhooks, err := strconv.ParseBool(os.Getenv("ENABLE_WEBHOOKS")); enableWebhooks || err != nil {
		if err = (&agentoperatorv1.VcAgent{}).SetupWebhookWithManager(mgr); err != nil {
			log.Error(err, "unable to create webhook", "webhook", "VcAgent")
			os.Exit(1)
		}
	}
	...
	if err := controllers.Add(mgr); err != nil {
		log.Error(err, "Failure setting up VC Agent Controller")
		os.Exit(1)
	}
