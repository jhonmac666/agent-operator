...
import (
	...
	v1 "github.com/jhonmac666/agent-operator/api/v1"
...
func (src *VcAgent) convertInternalSpecTo(dst *v1.VcAgent) {
	srcSpec := src.Spec
...
func (src *VcAgent) convertStatusTo(dstStatus *v1.VcAgentStatus) {
...
func (dst *VcAgent) convertStatusFrom(srcStatus v1.VcAgentStatus) {
