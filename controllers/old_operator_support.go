...
func (r *VcAgentReconciler) getAndDeleteOldOperator(ctx context.Context) (bool, error) {
...
func (r *VcAgentReconciler) getAndDeleteOldOperatorResources(ctx context.Context) (bool, error) {
	...
	managedByReq, _ := labels.NewRequirement(ManagedByLabelKey, selection.Equals, []string{"agent-operator"})
...
func (r *VcAgentReconciler) deleteResourcesOfType(ctx context.Context, toBeDeletedType ObjectListItemsConversion, selector labels.Selector) (bool, error) {
...
func (r *VcAgentReconciler) deleteResource(ctx context.Context, item client.Object) error {
